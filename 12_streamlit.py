...
input_feature4 = int(st.number_input('For how many years do you have your Instagram profile?')) # featureX4
input_feature5 = int(st.number_input('How many likes do you have on your last 3 posts?')) # featureX5
input_feature6 = int(st.number_input('How many comments do you have on your last 3 posts?')) # featureX6
